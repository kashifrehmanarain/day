                    ...
                    <div class="row row-rl-15 row-tb-15 t-center">
                        ...
                        <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                            <a href="store_single_01.html" class="panel is-block">
                                <div class="embed-responsive embed-responsive-4by3">
                                    <div class="store-logo">
                                        <img src="/f/assets/images/brands/brand_09.jpg" alt="">
                                    </div>
                                </div>
                        ...
                        <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                            <a href="store_single_01.html" class="panel is-block">
                                <div class="embed-responsive embed-responsive-4by3">
                                    <div class="store-logo">
                                        <img src="/f/assets/images/brands/brand_10.jpg" alt="">
                                    </div>
                                </div>
                        ...
                        <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                            <a href="store_single_01.html" class="panel is-block">
                                <div class="embed-responsive embed-responsive-4by3">
                                    <div class="store-logo">
                                        <img src="/f/assets/images/brands/brand_11.jpg" alt="">
                                    </div>
                                </div>
                        ...
                        <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                            <a href="store_single_01.html" class="panel is-block">
                                <div class="embed-responsive embed-responsive-4by3">
                                    <div class="store-logo">
                                        <img src="/f/assets/images/brands/brand_12.jpg" alt="">
                                    </div>
                                </div>
